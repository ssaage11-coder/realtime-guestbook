...
- `memory-bank/profile-prd.md`

이 문서들은 현재 제품 의도, 기술 구조, 구현 순서, 진행 상태, 사용자 프로필 요구사항의 기준 자료다.
...
- 사용자 프로필 목표, 기능 정의, 사용자 스토리, 필수/권장 요구사항이 바뀌면 `memory-bank/profile-prd.md`를 최신 상태로 갱신한다.
...
<!-- SPECKIT START -->
Current feature plan: `specs/001-user-profiles/plan.md`
<!-- SPECKIT END -->
